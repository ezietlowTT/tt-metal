...
#include "ttnn/operations/experimental/ccl/wan_fused_distributed_rmsnorm/wan_fused_distributed_rmsnorm_nanobind.hpp"
...
void py_module(nb::module_& mod) {
    ...
    ccl::bind_wan_fused_distributed_rmsnorm(mod);
